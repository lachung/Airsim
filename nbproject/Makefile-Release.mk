...
${OBJECTDIR}/income_statement_data.o: income_statement_data.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/income_statement_data.o income_statement_data.c

${OBJECTDIR}/income_statement_history.o: income_statement_history.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/income_statement_history.o income_statement_history.c
...
${OBJECTDIR}/route.o: route.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/route.o route.c

${OBJECTDIR}/route_data.o: route_data.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/route_data.o route_data.c

${OBJECTDIR}/route_process.o: route_process.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/route_process.o route_process.c

${OBJECTDIR}/sales_route_history.o: sales_route_history.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/sales_route_history.o sales_route_history.c

${OBJECTDIR}/staff.o: staff.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/staff.o staff.c
